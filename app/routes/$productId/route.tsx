...
import { createCartItem, createCart } from "~/models/cart.server";
import { getUserFromSession } from "~/utils/sessions.server";
import { DataFunctionArgs, redirect } from "@remix-run/node";
import { sessionStorage } from "~/utils/sessions.server";
import { USER_SESSION_KEY } from "~/utils/sessions.server";
import crypto from "crypto";
import { getProductInformation } from "~/utils/utils.server";
const Product = () => {
