...
function ProductItem({ img, price, id }) {
  return (
    <Link to={`/${id}`}>
      <div className=" m-6 overflow-hidden rounded-lg hover:shadow-slate-500 hover:shadow-md transition-shadow duration-200 w-36 sm:w-60 relative group text-negro font-raleway">
        ...
        <div className="flex flex-col justify-center px-1 border-b-2 border-b-negro border-x-2 border-x-negro rounded-b-lg overflow-hidden m-0">
